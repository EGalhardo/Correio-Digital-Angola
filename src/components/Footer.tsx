        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs lg:text-[13px] text-white font-bold">
              <li><Link to="/sobre-nos" className="hover:text-amber-400 transition-all hover:translate-x-1.5 inline-block">Sobre Nós</Link></li>
              <li><Link to="/como-funciona" className="hover:text-amber-400 transition-all hover:translate-x-1.5 inline-block">Como Funciona</Link></li>
              <li><a href="/#planos" className="hover:text-amber-400 transition-all hover:translate-x-1.5 inline-block">Planos</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs lg:text-[13px] text-white font-bold">
              <li><Link to="/central-ajuda" className="hover:text-amber-400 transition-all hover:translate-x-1.5 inline-block">Central de Ajuda</Link></li>
              <li><Link to="/faq" className="hover:text-amber-400 transition-all hover:translate-x-1.5 inline-block">FAQ</Link></li>
              <li><Link to="/video-tutorial" className="hover:text-amber-400 transition-all hover:translate-x-1.5 inline-block">Vídeo Tutorial</Link></li>
            </ul>
          </div>
